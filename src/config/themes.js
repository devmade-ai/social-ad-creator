...
export const presetThemes = [
  ...
  // Original theme: vivid orange (#f97316) + cream (#fef3c7) + red (#dc2626).
  // Both variants use red accent — orange vs red contrast is the theme's identity.
  // Dark variant restores the original palette directly.
  {
    id: 'sunset',
    name: 'Sunset',
    defaultVariant: 'light',
    variants: {
      light: { primary: '#fffbeb', secondary: '#9a3412', accent: '#dc2626' },
      dark: { primary: '#f97316', secondary: '#fef3c7', accent: '#dc2626' },
    },
  },
